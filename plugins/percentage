/* Codded by @Amal
Telegram: t.me/Amal.aj
Instagram: www.instagram.com/Amal.aj6
*/
...
if (Config.WORKTYPE == 'private') {
    if (Config.LANG == 'TR' || Config.LANG == 'AZ') {
        Asena.addCommand({ pattern: 'per ?(.*)', fromMe: true, desc: ask, warn: text}, (async (message, match) => { 
        ...
        Asena.addCommand({ pattern: 'per ?(.*)', fromMe: true, desc: love, warn: wn}, (async (message, match) => { 
            if (match[1].includes(' ')) { var split = match[1].split(' '), isimbir = split[1], isimiki = split[0] 
                var r_text = new Array ();
                r_text[0] = "*%0*";
                r_text[1] = "*%1*";
    ...
    if (Config.LANG == 'TR' || Config.LANG == 'AZ') {
        Asena.addCommand({ pattern: 'per ?(.*)', fromMe: false, desc: ask, warn: text}, (async (message, match) => { 
            if (match[1].includes(' ')) { var split = match[1].split(' '), isimbir = split[1], isimiki = split[0] 
                var r_text = new Array ();
                r_text[0] = "*%0*";
                r_text[1] = "*%1*";
        ...
        Asena.addCommand({ pattern: 'per ?(.*)', fromMe: false, desc: love, warn: wn}, (async (message, match) => { 
            if (match[1].includes(' ')) { var split = match[1].split(' '), isimbir = split[1], isimiki = split[0] 
                var r_text = new Array ();
                r_text[0] = "*%0*";
                r_text[1] = "*%1*";
